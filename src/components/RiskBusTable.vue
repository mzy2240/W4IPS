<template>
	<v-card>
		...
		<v-card-text class="pa-0">
			<template>
				<v-data-table :headers="headers" :items="$store.state.riskBuses" :rows-per-page-items="defaultRowItems" v-model="selected" select-all disable-initial-sort item-key="name">
